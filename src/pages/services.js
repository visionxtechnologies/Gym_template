  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Various pricing options available with being a Member of the crossfit gym. Whether you're new to the gym or an experienced lifter we have a plan that fits your needs."
        />
