...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>The Crossfit Gym</title>
        <meta
          name="description"
          content="Unlock your greatness and forge the body you want at The Crossfit Gym We offer personalized training, a juice bar, sauna & spa, and professional trainers to help you achieve your fitness goals. Join now and experience a game-changing fitness journey!"
        />
        <meta
          name="keywords"
          content="The Crossfit Gym, gym, fitness, personalized training, juice bar, sauna, spa, professional trainers, fitness goals, membership plans, gym membership, fitness journey"
        />
      ...
      <main className="bg-black w-screen">
          ...
          <div className="h-[85vh] overflow-hidden z-0 bg-[url('/images/landing.webp')] bg-cover bg-no-repeat w-screen">
            ...
            >
              <div className="w-full  md:w-2/5 mx-5 px-10 sm:px-5 py-10 leading-[3em] transition-all duration-300">
                ...
                <button
                  id="hero-cta"
                  className="bg-white my-4 py-3 px-6 text-sm uppercase font-bold border border-white hover:border-lime-600 transition-all duration-300"
                  onMouseEnter={() => {
                    document
                ...
                >
                  ...
                  <i
                    ...
                    className="relative fa-solid fa-arrow-right text-lime-500 left-0 transition-all duration-200"
                  ></i>
                </button>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-lime-600 to-lime-500">
          <div className="py-8 flex flex-col justify-center items-center text-white">
            <div className="text-sm uppercase tracking-[.5em] pb-10 font-medium">
              Closest Location
            </div>
            ...
            <div className="flex justify-center">
              <div className="flex gap-4 font-medium">
                <button
                  className="w-52 h-14 bg-white uppercase text-lime-700 tracking-[.2em] hover:tracking-[.1em] transition-all duration-300"
                  role="button"
                ...
                <button
                  className="w-36 h-14 bg-white uppercase text-lime-700 tracking-[.2em] hover:tracking-[.1em] transition-all duration-300"
                  role="button"
        ...
        <div className="bg-white flex flex-col gap-4 justify-center items-center">
          <div className="text-black  text-center text-2xl mt-10 mb-2.5 tracking-[.1em] uppercase flex justify-center items-center gap-2 font-semibold">
            <span>
              <div className="w-8 h-[2px] bg-gradient-to-r from-lime-500 to-lime-600"></div>
            </span>
            Our Services
            <span>
              <div className="w-8 h-[2px] bg-gradient-to-r from-lime-500 to-lime-600"></div>
        ...
        <div className="bg-white flex flex-col">
          <div className="bg-[url('/images/18410.webp')] bg-cover h-max bg-opacity-10 py-8">
            <div className="text-black  text-center text-2xl mt-10 mb-2.5 tracking-[.1em] uppercase flex justify-center items-center gap-2 font-semibold">
              <span>
                <div className="w-8 h-[2px] bg-gradient-to-r from-lime-500 to-lime-6000"></div>
              </span>
          ...
          <div className="flex max-w-[1000px] mx-10 my-16">
            ...
            <div className="max-w-[750px]">
              ...
              <div className="h-[325px] px-4 py-6 bg-black text-white align-bottom md:pl-24">
                ...
                >
                  &quot; has truly been a game-changer in my
                  ...
                  <div className="flex flex-col h-[px] justify-end">
                    <div className="flex gap-4">
                      <button
                        ...
                        className="bg-white my-4 py-3 px-6 text-sm uppercase font-bold text-black hover:bg-lime-500 hover:text-white transition-all duration-300"
                      >
                        <i
                      ...
                      <button
                        ...
                        className="bg-white my-4 sm:py-3 px-6 text-sm uppercase font-bold text-black hover:bg-lime-500 hover:text-white transition-all duration-300"
                      >
                        <i
