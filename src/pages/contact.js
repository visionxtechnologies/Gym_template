        ...
        <div className="bg-[url('/images/18410.webp')] bg-cover flex flex-col py-8 items-center border-b-2">
          <div className="flex justify-center w-full px-20">
            <div className="flex flex-col w-[1000px]">
              ...
              <div className="h-[2px] bg-lime-500 my-2"></div>
              <form>
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between">
                    <div className="flex flex-col w-[400px] ">
                      ...
                      <input
                        ...
                        id="nameInput"
                        name="name_input"
                        className="block border p-2 border-lime-500 text-gray-700 bg-gray-100 rounded-lg focus:ring-lime-500 focus:border-lime-500"
                      ></input>
                    </div>
                  ...
                  <div className="w-full h-[300px]">
                    ...
                    <textarea className="h-[200px] w-full block border p-2 border-lime-500 text-gray-700 bg-gray-100 rounded-lg focus:ring-lime-500 focus:border-lime-500"></textarea>
                  </div>
                </div>
              </form>
            </div>
