  ...
  return (
    ...
    >
      <div
        ...
        className="h-[200px] overflow-hidden relative border-b-2 border-lime-600"
        onMouseEnter={() => {
          document
      ...
      <div id="price-card-1-body" className="text-center h-[250px]">
        <div className="mx-auto relative bg-white -top-8 w-[250px] text-gray-600">
          ...
          <div className="flex justify-center relative left-2">
            ...
            <div className="font-medium text-[1em] relative top-8">/year</div>
          </div>
      ...
      <div className="price-card-1-footer h-[150px] flex justify-center items-center">
        <button
          id={"price-btn-" + tier}
          className="bg-white mt-4 py-4 px-6 text-sm uppercase font-bold border border-lime-600 transition-all duration-300 hover:py-6 hover:px-10 hover:bg-lime-600 hover:text-white"
        >
          Purchase Now
        </button>
      </div>
