    ...
    <>
      ...
      >
        ...
        <div className="lg:ml-[10%] flex gap-2 sm:gap-6 md:gap-12 lg:gap-20 md:text-sm lg:text-lg">
          <button className= "  hover:text-white hover:border-b-2 border-green-600 transition-all duration-50 [text-shadow:_0_1px_1px_rgb(0_0_0_/_100%)]"
